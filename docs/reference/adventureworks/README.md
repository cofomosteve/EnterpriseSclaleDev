...
|:-------------|:--------------|:--------------|
|![Best Practice Check](https://azurequickstartsservice.blob.core.windows.net/badges/subscription-deployments/create-rg-lock-role-assignment/BestPracticeResult.svg)| [![Deploy To Azure](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/1-CONTRIBUTION-GUIDE/images/deploytoazure.svg?sanitize=true)](https://portal.azure.com/#blade/Microsoft_Azure_CreateUIDef/CustomDeploymentBlade/uri/https://github.com/cofomosteve/EnterpriseSclaleDev/tree/main/docs/reference/adventureworks/armTemplates/es-hubspoke.json/createUIDefinitionUri/https://github.com/cofomosteve/EnterpriseSclaleDev/tree/main/docs/reference/adventureworks/armTemplates/portal-es-hubspoke.json)  | Yes |
